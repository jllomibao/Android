...
import x40240.jeffrey.lomibao.a5.db.DBHelper;
import x40240.jeffrey.lomibao.a5.model.DeviceInfo;

import static x40240.jeffrey.lomibao.a5.db.DBHelper.KEY_LRV;
import static x40240.jeffrey.lomibao.a5.db.DBHelper.KEY_MANUAL_TEMP;
import static x40240.jeffrey.lomibao.a5.db.DBHelper.KEY_TAG;
import static x40240.jeffrey.lomibao.a5.db.DBHelper.KEY_TEMP_COMP;
import static x40240.jeffrey.lomibao.a5.db.DBHelper.KEY_URV;
